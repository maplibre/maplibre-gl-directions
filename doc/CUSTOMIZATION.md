For the sakes of your convenience, make sure you've enabled the "Protected" filter:

![Enabling the "Public/Protected" filter](https://raw.githubusercontent.com/maplibre/maplibre-gl-directions/main/doc/images/protected-filter.png)
