...

    {
      ...
      paint: {
        "line-color": [
          ...
          "#63c4ff",
          ["interpolate-hcl", ["linear"], ["get", "congestion"], 0, "#7b51f8", 1, "#42c74c", 100, "#d72359"],
        ],
        "line-opacity": 0.55,
        "line-width": [
...

    {
      ...
      paint: {
        ...
        "circle-color": [
          "case",
          ["==", ["get", "profile"], "foot"],
          ["case", ["boolean", ["get", "highlight"], false], "#2732ff", "#5159f8"],
          ["==", ["get", "profile"], "bike"],
          ["case", ["boolean", ["get", "highlight"], false], "#0bb8ff", "#63c4ff"],
