<template>
  <svg
    ...
    version="1.0"
    :width="props.configuration.size"
    :height="props.configuration.size"
    viewBox="0 0 128 128"
    xml:space="preserve"
    :class="props.configuration.class"
  >
    <circle cx="64.13" cy="64.13" r="27.63" :fill="props.configuration.fill" />
    <path
